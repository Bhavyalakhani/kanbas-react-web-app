        ...
        .then((details) => {
          ...
          setQuizDetails({
            ...
            availableDate: details.availableDate
              ? formatDateForInput(details.availableDate)
              : "",
            untilDate: details.untilDate
              ? formatDateForInput(details.untilDate)
              : "",
          });
        })
        .catch((error) =>
      ...
      {activeTab === "detail" && (
        <>
          ...
          <ReactQuill
            ...
            className="mb-2"
            onChange={(value) =>
              setQuizDetails((prev) => ({ ...prev, description: value }))
            }
          />
          <br />
          <br />
          ...
          <div className="form-check">
            <input
              ...
              defaultChecked={quizDetails.shuffleAnswers}
            />
            <label htmlFor="shuffle" className="form-check-label ms-2">
              {" "}
              Shuffle Answers
            </label>
          </div>
          ...
          <input
            ...
            value={quizDetails.allowedAttempts}
            onChange={handleChange}
            className="form-control mb-2"
          />
          ...
          <select
            ...
            value={quizDetails.showCorrectAnswers.toString()}
            onChange={handleChange}
            className="form-select"
          >
          ...
          <select
            name="webcamRequired"
            value={quizDetails.webcamRequired.toString()}
            onChange={handleChange}
            className="form-select"
          >
            <option value="false">No</option>
          ...
          <select
            ...
            value={quizDetails.oneQuestionAtATime.toString()}
            onChange={handleChange}
            className="form-select"
          >
            <option value="true">Yes</option>
          ...
          <select
            ...
            value={quizDetails.lockQuestionsAfterAnswering.toString()}
            onChange={handleChange}
            className="form-select"
          >
            <option value="false">No</option>
          ...
          <div className="mb-3 row">
            <label
              ...
              className="mt-4 col-sm-4 col-form-label text-end"
            >
              Assign
            </label>

            <div
              className="mt-4 col-sm-8"
              style={{
