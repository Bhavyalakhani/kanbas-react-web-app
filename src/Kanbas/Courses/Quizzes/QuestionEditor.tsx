...
export default function QuestionEditor({ quizDetails, setQuizDetails }: any) {
    ...
    if (typeof index === "number") {
      ...
      setQuizDetails((prev: any) => ({
        ...
        points: updatedQuestions.reduce(
          (acc: number, question: any) => acc + (question.points || 0),
          0
      ...
      setQuizDetails((prev: any) => ({
        ...
        points: [...prev.questions, questionData].reduce(
          (acc: number, question: any) => acc + (question.points || 0),
          0
        ), // Recalculate total points
      }));
  ...
  return (
    <div className="container">
      <h4 className="text-black font-weight-bold mb-4">
        Total Points:{" "}
        {quizDetails.questions.reduce(
          (acc: number, question: any) => acc + (question.points || 0),
          0
        )}
      </h4>
      ...
      {showNewQuestionEditor && (
        <div
          ...
          style={{ backgroundColor: "#f5c6cb", border: "1px solid #f5c6cb" }}
        >
          <h5 className="font-weight-bold">
            This is a preview question, edit and save it.
          </h5>
