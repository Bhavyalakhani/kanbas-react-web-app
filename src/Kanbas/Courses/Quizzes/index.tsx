    ...
    const loadQuizzes = async () => {
      if (cid) {
        ...
        for (const quiz of filteredQuizzes) {
          const userAttempt = await quizClient.getAttemptsForUserAndQuiz(
            currentUser._id,
            quiz._id
          );
        ...
        <li className="wd-module list-group-item p-0 mb-5 fs-5 border-gray">
          ...
          <ul className="wd-lessons list-group rounded-0 wd-padded-left wd-bg-color-green">
            {quizzes.map((quiz: any) => {
              ...
              const lastAttemptScore = getLastAttemptScore(
                quiz._id,
                quiz.points
              );
              ...
              return (
                ...
                >
                  ...
                  <div className="quiz-details flex-grow-1">
                    <strong>
                      {currentUser.role === "FACULTY" ||
                      (!availability.includes("Not Available Until") &&
                        availability !== "Closed") ? (
                        <Link
                    ...
                    <h6>
                      <p className="wd-fg-color-red">
                        ...
                        <span className="wd-fg-color-black">
                          ...
                          |<b> Due Date:</b>{" "}
                          {formatDateForInput(quiz.dueDate) || "No Due Date"} |
